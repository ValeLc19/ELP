...
const DICT = {
  en: {
    ...
    verifyText:
      'We sent a confirmation link to your email. Open it to activate your account, then come back and log in.',
    resend: 'Resend email',
    resendDone: 'Sent again — check your inbox.',
    backToLogin: 'Back to log in',
    errUnverified: 'Please confirm your email first — check your inbox.',
    working: 'Working…',
    // onboarding
    addBizHeading: 'Add a local business’s social media account to pull in the events they post.',
    onb1: 'In your profile, open “My Local Business” to add a business’s social account and pull in the events they post.',
  ...
  es: {
    ...
    verifyText:
      'Enviamos un enlace de confirmación a tu correo. Ábrelo para activar tu cuenta y luego vuelve a iniciar sesión.',
    resend: 'Reenviar correo',
    resendDone: 'Enviado de nuevo — revisa tu bandeja.',
    backToLogin: 'Volver a iniciar sesión',
    errUnverified: 'Confirma tu correo primero — revisa tu bandeja.',
    working: 'Procesando…',
    addBizHeading: 'Agrega la cuenta de redes sociales de un negocio local para traer los eventos que publican.',
    onb1: 'En tu perfil, abre “Mis negocios locales” para agregar la cuenta de un negocio y traer los eventos que publican.',
